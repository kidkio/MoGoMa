# how to activate virtual env : source ./bin/activate
...
app.config['UPLOAD_FOLDER'] = "/home/ubuntu/environment/MoGoMa/uploads"
...
def download():
    ...
    s = os.path.split(s[0])
    print(s[1])
    processing(title=s[1],file_path=file_path)
    return send_from_directory("/home/ubuntu/environment/MoGoMa/result",s[1]+".docx", as_attachment=True)
...
def processing(title,file_path):
    ...
    doc.save("/home/ubuntu/environment/MoGoMa/result/"+f"{title}.docx")
